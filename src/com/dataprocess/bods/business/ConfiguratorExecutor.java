...
public final class ConfiguratorExecutor {
     ...
     * @throws BODSException the bODS exception
     */
    private void loadRecordsIntoStagingTable(String stagingTableName, ConfiguratorVO configuratorVO,
    ...
    private int loadRecords(int rowCount, List<ConfiguratorColumnDefinitionVO> mappingList, ResultSet resultSet,
        ...
        try {
            ...
            /*
             * preparedStatement.setString(++count, ""); preparedStatement.setString(++count, "");
             * preparedStatement.setLong(++count, migMapping.getDataTemplateId()); preparedStatement.setLong(++count,
             * userId); preparedStatement.setLong(++count, ldrExecId); preparedStatement.setInt(++count, ++rowCount);
