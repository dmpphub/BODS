...
public final class Configurator {
	 ...
	 *             the bODS exception
	 */
	public List<ConfiguratorColumnDefinitionVO> getSourceConfiguratorColumn(
			int sourceConfiguratorId) throws BODSException {
		...
		try {
			...
			queryDefinitionEO = configuratorDAO
					.getSourceConfigurator(sourceConfiguratorId);
			queryDefinitionVO = (QueryDefinitionVO) new SpringBeanUtils()
					.populateToDTOObject(queryDefinitionEO, queryDefinitionVO);
			configuratorColDefnList = fillConfiguratorColumnDefinitionVOList(queryDefinitionVO
					.getSourceConfiguratorLineVOSet());

		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"getSourceConfiguratorColumn", exception.getMessage());
		}
	 ...
	 *
	 * @param queryDefinitionLineVO
	 *            the query definition line vo
	 * @return the list
	 * @throws BODSException
	 *             the bODS exception
	 */
	private List<ConfiguratorColumnDefinitionVO> fillConfiguratorColumnDefinitionVOList(
			Set<QueryDefinitionLineVO> queryDefinitionLineVO)
			throws BODSException {
		...
		try {
			...
			for (QueryDefinitionLineVO sourceConfiguratorLineVO1 : queryDefinitionLineVO) {
				...
				configuratorColumnDefinitionVO
						.setColumnName(sourceConfiguratorLineVO1
								.getColumnName());
				configuratorColumnDefinitionVO
						.setColumnId(sourceConfiguratorLineVO1
								.getSourceConfiguratorLineId());
				configuratorColumnDefinitionVO
						.setDataType(sourceConfiguratorLineVO1.getDataType());
				configuratorColumnDefinitionVO
						.setConversionColumn(sourceConfiguratorLineVO1
								.getConversionColumn());
				configuratorColumnDefinitionVO
						.setMandatory(sourceConfiguratorLineVO1
								.getColumnMandatoryFlag());
				configuratorColumnDefinitionVO
						.setUnique(sourceConfiguratorLineVO1
								.getColumnUniqueFlag());
				configuratorColDefnList.add(configuratorColumnDefinitionVO);
			}
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"fillConfiguratorColumnDefinitionVOList",
	 ...
	 *             the bODS exception
	 */
	public List<ConfiguratorInterfaceColumnVO> getInterfaceTableColumnList(
			ConfiguratorVO configuratorVO) throws BODSException {
		String tableName = "";
		ConfiguratorDAO configuratorDAO = null;
		List<ConfiguratorInterfaceColumnVO> configuratorInterfaceColumnVOList = null;
		try {
			configuratorDAO = new ConfiguratorDAO();
			tableName = configuratorVO.getConfiguratorInterfaceColumnVO()
					.getTableName();
			configuratorInterfaceColumnVOList = configuratorDAO
					.getInterfaceTableColumnList(
							configuratorVO.getConfiguratorConnectionId(),
							tableName);
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"getInterfaceTableColumnList", exception.getMessage());
		}
	 ...
	 *             the bODS exception
	 */
	public void createConfiguratorDynamicTable(ConfiguratorVO configuratorVO)
			throws BODSException {
		...
		try {
			...
			connection = targetSchemaConnection
					.getTargetSchemaConnection(configuratorVO
							.getConfiguratorConnectionId());
			tableName = "STG_" + configuratorVO.getConfiguratorConnectionId()
					+ "_" + configuratorVO.getConfiguratorId();
			pvtableName = "PV_" + configuratorVO.getConfiguratorConnectionId()
					+ "_" + configuratorVO.getConfiguratorId();
			stagingTableScript += generatePVTableScripts(pvtableName);
			configuratorDAO.createPrevalidationTable(connection,
					stagingTableScript, pvtableName);
			pvColumn = configuratorDAO.insertPrevalidationValues(connection,
					pvtableName, configuratorVO);
			stagingTableScript = "";
			stagingTableScript = "CREATE TABLE " + tableName;
			stagingTableScript += getColumnList(pvColumn,
					configuratorVO.getConfiguratorColumnDefinitionVOList());
			configuratorDAO.createStagingTable(connection, stagingTableScript,
					tableName);
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"createConfiguratorDynamicTable", exception.getMessage());
		} finally {
			targetSchemaConnection.targetSchemaClose(connection, null, null,
					null);
		}
	}
	 ...
	 *
	 * @param pvStagingTable
	 *            the pv staging table
	 * @return the string
	 * @throws BODSException
	 *             the bODS exception
	 */
	public String generatePVTableScripts(String pvStagingTable)
			throws BODSException {
		...
		try {
			...
			throw new BODSException("Configurator", "generatePVTableScripts",
					exception.getMessage());
		}
	...
	private String getColumnList(
		...
		try {
			for (ConfiguratorColumnDefinitionVO configuratorColumnDefinitionVO : configuratorColumnDefinitionVOList) {
				if (index == 0) {
					if ("String"
							.equalsIgnoreCase(configuratorColumnDefinitionVO
									.getDataType())) {
						columnName = configuratorColumnDefinitionVO
								.getColumnName() + " VARCHAR2(2000) ";
					} else {
						columnName = configuratorColumnDefinitionVO
								.getColumnName()
								+ " "
			...
			commonColumnName = " , LINE_NO NUMBER, EXECUTION_ID NUMBER, CONFIGURATOR_ID NUMBER, STATUS_CODE VARCHAR2(3), DC_FLAG VARCHAR2(3)";
	 ...
	 *             the bODS exception
	 */
	public String parseQuery(ConfiguratorVO configuratorVO)
			throws BODSException {
		...
		try {
			...
			prevalidationQuery = configuratorVO.getConfiguratorValidationVO()
					.getValidationQuery();
			referenceColumnNameList = configuratorValidationDAO.parseQuery(
					connection, prevalidationType, prevalidationQuery);
			valueObject.append("queryColumnNameList", referenceColumnNameList);
			valueObject.append("configuratorColumnVOList",
					configuratorVO.getConfiguratorColumnDefinitionVOList());
			...
			throw new BODSException("Configurator", "parseQuery",
					exception.getMessage());
		}
		return jsonString;
	}
	...
	public ArrayList<ConfiguratorVO> getConfigConnectionList()
		...
		try {
			...
			throw new BODSException("Configurator", "getConfigConnectionList",
					exception.getMessage());
		}
	...
	public ArrayList<ConfiguratorVO> getSourceConfigConnectionList()
		...
		try {
			configuratorDAO = new ConfiguratorDAO();
			sourceConfigConnectionList = configuratorDAO
					.getSourceConfigConnectionList();
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"getSourceConfigConnectionList", exception.getMessage());
		}
	...
	public ArrayList<ConfiguratorVO> getSourceConfigurationNameList()
		...
		try {
			configuratorDAO = new ConfiguratorDAO();
			sourceConfigurationNameList = configuratorDAO
					.getSourceConfigurationNameList();
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator",
					"getSourceConfigurationNameList", exception.getMessage());
		}
	...
	public void saveConfiguratorDetails(ConfiguratorVO configuratorVO)
		...
		try {
			...
			configuratorProcedureCreation
					.createStagingProcedure(configuratorVO);
			configuratorProcedureCreation
					.createValidationProcedure(configuratorVO);
			configuratorBinariesEO.setObject(bytesUtil
					.toByteArray(configuratorVO));
			configuratorEO = (ConfiguratorEO) beanUtils.populateToEntityObject(
					configuratorVO, configuratorEO);
			configuratorBinariesEOSet.add(configuratorBinariesEO);
			configuratorEO
					.setConfiguratorBinariesEOSet(configuratorBinariesEOSet);
			configuratorEO = configuratorDAO
					.saveConfiguratorDetails(configuratorEO);
			if (configuratorEO.getConfiguratorId() > 0) {
				configuratorVO.setConfiguratorId(configuratorEO
						.getConfiguratorId());
	 ...
	 *             the bODS exception
	 */
	public void fetchConfiguratorList(ConfiguratorVO configuratorVO)
			throws BODSException {
		ConfiguratorDAO configuratorDAO = null;
		try {
			configuratorDAO = new ConfiguratorDAO();
			...
			throw new BODSException("Configurator", "fetchQueryDefinitionList",
					exception.getMessage());
		}
	}
	 ...
	 *             the bODS exception
	 */
	public ConfiguratorVO fetchConfigurationDetails(
			ConfiguratorVO configuratorVO) throws BODSException {
		ConfiguratorDAO configuratorDAO = null;
		ConfiguratorEO configuratorEO = null;
		BytesUtil bytesUtil = null;
		try {
			configuratorDAO = new ConfiguratorDAO();
			bytesUtil = new BytesUtil();
			configuratorEO = configuratorDAO.fetchConfigurator(configuratorVO
					.getConfiguratorId());
			configuratorVO = (ConfiguratorVO) bytesUtil.toObject(configuratorEO
					.getConfiguratorBinariesEOSet().iterator().next()
					.getObject());

		} catch (Exception exception) {
			exception.printStackTrace();
			throw new BODSException("Configurator",
					"fetchConfigurationDetails", exception.getMessage());
		}
	 ...
	 * @param dataTemplateName
	 *            the data template name
	 * @return the staging table detail
	 * @throws BODSException
	 *             the bODS exception
	 */
	public String getStagingTableDetail(String stagingTableName,
			String dataTemplateName) throws BODSException {
		String chartValueStr = "";
		String chartContent = "";
		ConfiguratorDAO configuratorDAO = null;
		try {
			configuratorDAO = new ConfiguratorDAO();
			chartValueStr = configuratorDAO
					.getStagingTableDetailForPieChart(stagingTableName);
			chartContent = generatePieChart(dataTemplateName, chartValueStr);
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator", "getStagingTableDetail",
					exception.getMessage());
		}
		return chartContent;
	}
	 ...
	 *             the bODS exception
	 */
	private String generatePieChart(String dataTemplate, String chartValueStr)
			throws BODSException {
		String chartName = "";
		...
		try {
			...
			dataSet.setValue(new Double(chartValueArr[0]), "Total Count",
					"Total");
			dataSet.setValue(new Double(chartValueArr[1]), "Success Count",
					"Success");
			dataSet.setValue(new Double(chartValueArr[2]), "Error Count",
					"Error");
			final JFreeChart chart = ChartFactory.createBarChart(dataTemplate,
					"Record Type ", "Total Count", dataSet,
			...
			throw new BODSException("Configurator", "generatePieChart",
	 ...
	 *             the bODS exception
	 */
	public String getPrevalidationDetail(String stagingTableName)
			throws BODSException {
		int totalRec = 0;
		int successRec = 0;
		int errorRec = 0;
		...
		try {
			...
			configuratorDAO = new ConfiguratorDAO();
			prevalidationStatusVOList = configuratorDAO
					.getPrevalidationStatus(stagingTableName);
			for (PrevalidationStatusVO prevalidationStatusVO1 : prevalidationStatusVOList) {
				totalRecord = prevalidationStatusVO1.getErrorCount()
						+ prevalidationStatusVO1.getSuccessCount();
				totalRec = Integer.parseInt(totalRecord);
				successRec = Integer.parseInt(prevalidationStatusVO1
						.getSuccessCount());
				errorRec = Integer.parseInt(prevalidationStatusVO1
						.getErrorCount());
				prevalidationStatusVO1.setSuccessPrecentage(getPercentage(
						totalRec, successRec));
				prevalidationStatusVO1.setErrorPrecentage(getPercentage(
						totalRec, errorRec));
			}
			valueObject.append("prevalidationStatusVO",
					prevalidationStatusVOList);
			prevalidationVOJSON.put("configuratorVO", valueObject);
			prevalStr = prevalidationVOJSON.toString();
		} catch (BODSException bodsException) {
			throw bodsException;
		} catch (Exception exception) {
			throw new BODSException("Configurator", "getPrevalidationDetail",
					exception.getMessage());
		}
		return prevalStr;
	}
	...
	public String getPercentage(int total, int count) throws BODSException {
		...
		try {
			...
			throw new BODSException("Configurator", "getPercentage",
					exception.getMessage());
		}
		return percentage;
	}
